    ...
    class Program
    {
        ...
        public static void Game_PC_Chars(char[,] game_bored)
        {
            ...
            while (sum_points != pairs)
            {
                ...
                while (0 >= FirstCardRow || FirstCardRow > game_bored.GetLength(0) || 0 >= FirstCardColumn || FirstCardColumn > game_bored.GetLength(0));
                ...
                while (0 >= SecondCardColumn || SecondCardColumn > game_bored.GetLength(1) || 0 >= SecondCardRow || SecondCardRow > game_bored.GetLength(1));
